...
.red[But still]: there is no supreme governing power at global level (i.e. no country/organization could call all the shots)
...
- Come up with a plan (i.e. with steps)
...
```{r cntwealth, echo=FALSE, warning=FALSE, cache=TRUE}
library(DiagrammeR)
m <- mermaid("graph LR;
      A[Initial state: <br> small pile of money <br> or just you] -- Hard Work --> B[Accumulate wealth];
      B -- Repeat --> C[Positive cycle]")
...
![:wscale 90%](https://cdn.static-economist.com/sites/default/files/images/print-edition/20171007_SRC647_1.png)
...
![](http://www.tvweeklynow.com/images/9073/RIcksPix/Press%20Images%20Jun15/TimeforSchool%20logo.jpg)
...
The Bretton Woods System had profound influence on the development of these structures and lasting influence through institutions
