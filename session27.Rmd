...
- Creation of the nation state as the main actor, an imagined community. But also threatened by the globalization process.
...
Geographic location tends to create space and define boundry but so are our actions.  
...
- .violet[Learn, unlearn, and relearn]: This is how you deal with unpredictability. The world and your career are unpredictable, so you need periodically recreate yourself.
...
Student feedback quesionnaire: [now until 30/11] (https://isw.umac.mo/siweb)

Submission period of final project: .green[26/11 - 30/11 (23:55)]

Project display & comment: .green[now until 05/12 23:59]
